...
interface ReadCodesScreenProps {
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-3">
        ...
        <h1 className="font-semibold text-3xl tracking-tight">Read Codes</h1>
      ...
      <Card className="border border-white/12 bg-black/18 shadow-[0_10px_30px_rgba(0,0,0,0.2)] backdrop-blur-2xl">
        ...
        <CardContent>
          ...
          {errorMessage !== null && <p className="text-rose-300 text-sm">{errorMessage}</p>}
